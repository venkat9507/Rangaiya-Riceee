package com.android.rangaiyaasrice;
...
import com.android.rangaiyaasrice.util.IabBroadcastReceiver;
import com.android.rangaiyaasrice.util.IabHelper;
import com.android.rangaiyaasrice.util.IabResult;
import com.android.rangaiyaasrice.util.Inventory;
import com.android.rangaiyaasrice.util.NetworkHandler;
import com.android.rangaiyaasrice.util.PermissionUtil;
import com.android.rangaiyaasrice.util.Pref;
import com.android.rangaiyaasrice.util.ProgressDialogHelper;
import com.android.rangaiyaasrice.util.Purchase;
import com.android.rangaiyaasrice.util.UrlHandler;
import com.android.rangaiyaasrice.R;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, DownloadListener, IabBroadcastReceiver.IabBroadcastListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onResume() {
        ...
        rangaiyaasriceWeb.activityResumed();
        hideStatusBar();
        checkURL(getIntent());
        new Handler().postDelayed(new Runnable() {
            @Override
    ...
    protected void onPause() {
        ...
        rangaiyaasriceWeb.activityPaused();
